...
lapply(c(1:20), function(i) {
  write.tree(tree_s, file = paste0("tree_s_", i, ".newick"))
  write.tree(trees_ss[[i]], file = paste0("tree_ss_", i, ".newick"))
  write.tree(trees_sd[[i]], file = paste0("tree_sd_", i, ".newick"))
  write.tree(trees_sds[[i]], file = paste0("tree_sds_", i, ".newick"))
  write.tree(trees_bd[[i]], file = paste0("tree_bd_", i, ".newick"))
})
...
write.csv(treeParams, file = "treeParams.csv", quote = F, row.names = F)