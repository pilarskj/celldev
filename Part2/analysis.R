...
# tree parameters
treeParams = read.csv(paste0("Trees/", prototype, "/treeParams.csv"))  

# directory
dir = paste0(method, "/", prototype, "/")
...
trueTreesFiles = list.files(paste0("Trees/", prototype), pattern = ".typed.node.trees", full.names = T)
